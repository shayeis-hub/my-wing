...
const COPY = {
  he: {
    ...
    cta_trial: "ניסיון חינם 21 יום · לא צריך כרטיס אשראי",
    concept_text:
    ...
    final_sub: "הצטרף ל-Wingpact היום — 21 יום חינם, ללא צורך בכרטיס אשראי.",
  ...
  en: {
    ...
    cta_trial: "21-day free trial · No credit card required",
    concept_text:
    ...
    final_sub: "Join Wingpact today — 21 days free, no credit card needed.",
    footer_terms: "Terms",
...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      {/* ── Pricing teaser ── */}
      <section id="pricing" style={{ maxWidth: 600, margin: "0 auto", padding: "72px 24px", textAlign: "center" }}>
