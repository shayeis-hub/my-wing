    ...
    items: [
      {
        ...
        a: "כן! הורדים את האפליקציה הנייטיב (iOS), מוסיפים את הווידג'ט של Wingpact למסך הבית, ומשם ניתן לעדכן שתייה וצעדים ישירות — בלי לפתוח את האפליקציה.",
      },
      {
        q: "על אילו מכשירים האפליקציה עובדת?",
        a: "Wingpact עובדת כ-PWA (אפליקציית ווב) על כל דפדפן מודרני — Android, iOS, Desktop. אפליקציה נייטיב ל-iOS זמינה ב-App Store עם פיצ'רי ווידג'ט וצעדים אוטומטיים.",
      },
      {
        q: "האם הצעדים נספרים אוטומטית?",
        a: "על iOS, האפליקציה יכולה לקרוא נתוני HealthKit ולסנכרן צעדים ומשקל אוטומטית. על Android, הסנכרון מ-Google Fit בפיתוח.",
      },
    ],
  },
  {
