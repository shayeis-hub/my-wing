...
function LoginForm() {
  ...
  // Apple only requires this button on iOS — the underlying plugin has no
  // native Apple sign-in on Android, so don't risk it on the already-live
  // Android app for a button nobody needs there.
  ...
  async function handleApple() {
    ...
    try {
      ...
      toast.error(t("login_apple_error"));
    } finally {
