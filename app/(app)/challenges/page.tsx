  ...
  return (
    <div className="p-4 space-y-4">
      <div className="pt-4 flex items-center justify-between">
        <h1 className="text-xl font-bold text-wing-ink">אתגרים שבועיים</h1>
        {isMember && (
      ...
      {wing?.activeChallenge ? (
        ...
        <Card className="text-center py-8">
          ...
          <p className="font-semibold text-wing-ink">אין אתגר פעיל</p>
          <p className="text-sm text-wing-subtle mt-1">
            {isMember ? "צור אתגר חדש למבנה" : "המנהל עוד לא יצר אתגר"}
          </p>
        </Card>
      )}
      ...
      {showCreate && isMember && (
        <Card className="space-y-4 border-2 border-wing-border">
          <h3 className="font-bold text-wing-ink">אתגר חדש</h3>
