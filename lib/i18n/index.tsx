...
export const T = {
  he: {
    ...
    dashboard_full_checkin_title: "צ'ק-אין יומי מלא",
  ...
  en: {
    ...
    wing_checkin_action: "checked in",
    ...
    dashboard_full_checkin_title: "Full Daily Check-in",
    ...
    delete_warning_2: "All meals, check-ins and steps will be deleted",
